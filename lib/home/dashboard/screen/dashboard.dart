...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    ...
    widget.cubit.startSocket();
    super.initState();
  }

  @override
  void dispose() {
    widget.cubit.destorySocket();
    super.dispose();
  }
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    const SizedBox(),
                    Text(
                      authCubit.state.userProfileModel?.name ?? "",
                            ...
                            builder: (context, state) {
                              return SizedBox(
                                ...
                                child: ListView.separated(
                                  ...
                                  itemCount: state.companyProfileModel.projects
                                          ?.length ??
                                      0,
                                ),
                              );
                            ...
                            builder: (context, state) {
                              return SizedBox(
                                child: state.started
                                                                  ...
                                                                  BlocBuilder<
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return Row(
                                                                        children: [
                                                                          Text(
                                                                            timeParts.hours.toString().padLeft(2,
                                                                                '0'),
                                                                            style:
                                                                          ...
                                                                          Text(
                                                                            timeParts.minutes.toString().padLeft(2,
                                                                                '0'),
                                                                            style:
                                                                                AppStyles.largeDarkText,
                                                                          ),
                                                                          ...
                                                                          Text(
                                                                            timeParts.seconds.toString().padLeft(2,
                                                                                '0'),
                                                                            style:
                                                                                AppStyles.largeDarkText,
                                                                          )
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return SizedBox(
                                                                        ...
                                                                        child: ListView
                                                                          ...
                                                                          itemCount:
                                                                              state.companyProfileModel.projects?.length ?? 0,
                                                                        ),
                                                                      );
                                                                    },
                                                                  ),
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        InkWell(
                                                                          onTap:
                                                                              () {
                                                                            widget.cubit.stopTimer(note.text,
                                                                                context);
                                                                            note.clear();
                                                                          },
                                                                          child:
                                                                            ...
                                                                            decoration:
                                                                                BoxDecoration(color: ColorConstant.primaryColor, borderRadius: BorderRadius.circular(12)),
                                                                            child: Center(
                                                                                child: Text(
                                                                              'Send',
                                                                              style: TextStyle(color: ColorConstant.borderFillCOlor, fontSize: 17, fontWeight: FontWeightConstant.bold),
                                                                            )),
                                                                          ),
                                                                        )
                                                                      ],
                                    ...
                                    : InkWell(
                                        onTap: () => widget.cubit
                                            .startTaskTimer(context: context),
                                        child: DashboardButton(
                                          widget: state.status ==
